    ...
    public partial class SiteMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpContext.Current.Session["userActive"] != null)
            {
                ...
                //userFromBdd.app_rol = 1;
                if (userFromBdd != null)
                {                    
                    txtUser.Text = userFromBdd.nombres + " " + userFromBdd.apellidos;
                    Session["userActive"] = userFromBdd;
                    id_app_role.Value = Convert.ToString(userFromBdd.area);
